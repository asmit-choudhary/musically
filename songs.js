const NORMAL = {
    ...
    8: {
        name: "./songs/Songs/Happy/TERE NAAL NACHNA.m4a",
        artist: "Badshah",
        image: "./songs/images/tere-naal-nachna.jpg",
        wallpaper: "./songs/images/tere-naal-nachna-background.jpg",
      },
    9: {
        name: "./songs/Songs/Happy/OLD SKOOL.m4a",
        artist: "Prem Dhillon ft Sidhu Moose Wala",
        image: "./songs/images/old-skool.webp",
        wallpaper: "./songs/images/old-skool-background.jpg",
      },
    10: {
        name: "./songs/Songs/Happy/PALAZZO 2.m4a",
        artist: "Kulwinder Billa, Shivjot",
        image: "./songs/images/palazzo2.jpg",
        wallpaper: "./songs/images/palazzo2-background.jpg",
      },
    11: {
        name: "./songs/Songs/Aggressive/Badnam.m4a",
        artist: "Mankirt Aulakh Feat Dj Flow",
    ...
    15: {
        name: "./songs/Songs/High/3 Peg.m4a",
        artist: "Sharry Mann",
        image: "./songs/images/3peg.webp",
        wallpaper: "./songs/images/3peg-background.jpg",
      },
    16: {
        name: "./songs/Songs/High/5 Taara.m4a",
        artist: "Diljit Dosanjh",
        image: "./songs/images/5taara.webp",
        wallpaper: "./songs/images/5taara-background.jpg",
      },
    17: {
        name: "./songs/Songs/High/Bapu Zimidar.m4a",
        artist: "Jassi Gill",
        image: "./songs/images/Bapu-Zimidar.jpg",
        wallpaper: "./songs/images/Bapu-Zimidar-background.jpg",
      },
    18: {
        name: "./songs/Songs/High/BAROOD DIL.m4a",
        artist: "Korala Maan, Gurlej Akhtar",
        image: "./songs/images/BAROOD-DIL.webp",
        wallpaper: "./songs/images/BAROOD-DIL-background.jpeg",
      },
    19: {
          name: "./songs/Songs/High/Diamond.m4a",
          artist: "Gurnam Bhullar",
          image: "./songs/images/Diamond.webp",
          wallpaper: "./songs/images/Diamond-background.jpg",
        },
    20: {
          name: "./songs/Songs/High/Filmy Scene.m4a",
          artist: "Korala Maan, Gurlej Akhter",
          image: "./songs/images/Filmy-Scene.jpg",
          wallpaper: "./songs/images/Filmy-Scene-background.jpg",
        },
    21: {
          name: "./songs/Songs/High/Patiala Peg.m4a",
          artist: "Diljit Dosanjh",
          image: "./songs/images/Patiala-Peg.jpg",
          wallpaper: "./songs/images/Patiala-Peg-background.jpg",
        },
    22: {
          name: "./songs/Songs/High/Same Time Same Jagah.m4a",
          artist: "Sandeep Brar ft. Kulwinder Billa",
          image: "./songs/images/chaar-din.webp",
          wallpaper: "./songs/images/chaar-din-background.jpg",
        },
    23: {
          name: "./songs/Songs/High/Teeje Week.m4a",
          artist: "Jordan Sandhu",
          image: "./songs/images/Teeje-Week.webp",
          wallpaper: "./songs/images/Teeje-Week-background.jpg",
        },
    24: {
    ...
    29: {
          name: "./songs/Songs/Happy/On My Way.m4a",
...
const HAPPY = {
    0: {
        name: "./songs/Songs/Happy/Adhiya.m4a",
        artist: "Karan Aujla",
        image: "./songs/images/size_xxl_1603178934.webp",
        wallpaper: "./songs/images/Adhiya-background.jpg",
      },
    1: {
        name: "./songs/Songs/Happy/DILBAR.mp3",
        artist: "Satyameva Jayate",
        image: "./songs/images/dilbar.jpg",
        wallpaper: "./songs/images/dilbar-background.jpg",
      },
    2: {
        name: "./songs/Songs/Happy/Taki Taki.m4a",
        artist: "DJ Snake ft. Selena Gomez, Ozuna, Cardi B",
        image: "./songs/images/taki-taki.jpg",
        wallpaper: "./songs/images/taki-taki-background.jpg",
      },
    3: {
        name: "./songs/Songs/Happy/Garmi.m4a",
        artist: "Badshah, Neha Kakkar",
        image: "./songs/images/garmi.jpg",
        wallpaper: "./songs/images/garmi-background.jpg",
      },
    4: {
        name: "./songs/Songs/Happy/Baby.m4a",
        artist: "Justin Bieber",
        image: "./songs/images/baby.jpg",
        wallpaper: "./songs/images/justin-bieber-background.jpg",
      },
    5: {
        name: "./songs/Songs/Happy/TERE NAAL NACHNA.m4a",
    ...
    9: {
        name: "./songs/Songs/Happy/PANJEBAN.m4a",
        artist: "Shivjot, Gurlez Akhtar",
        image: "./songs/images/panjeban.jpg",
        wallpaper: "./songs/images/panjeban-background.jpg",
      },
    10: {
...
const HIGH = {
    ...
    4: {
        name: "./songs/Songs/High/COKA.m4a",
        artist: "Sukh-E Muzical Doctorz",
        image: "./songs/images/COKA.jpg",
        wallpaper: "./songs/images/COKA-background.jpg",
      },
    5: {
        name: "./songs/Songs/High/Daru Badnaam.m4a",
        artist: "Kamal Kahlon, Param Singh",
        image: "./songs/images/Daru-Badnaam.jpg",
        wallpaper: "./songs/images/Daru-Badnaam-background.jpg",
      },
    6: {
        name: "./songs/Songs/High/Diamond.m4a",
        artist: "Gurnam Bhullar",
    ...
    10: {
        name: "./songs/Songs/High/SLOWLY SLOWLY.m4a",
        artist: "Guru Randhawa ft. Pitbull",
        image: "./songs/images/SLOWLY-SLOWLY.jpeg",
        wallpaper: "./songs/images/SLOWLY-SLOWLY-background.jpg",
      },
    11: {
        name: "./songs/Songs/High/Teeje Week.m4a",
        artist: "Jordan Sandhu",
...
const RAP = {
  0:{
    ...
    image: "./songs/images/angaar.jpg",
    wallpaper: "./songs/images/angaar-background.jpg", 
  },
  1:{
    name: "./songs/Songs/Rap/BAAP SE.m4a",
    artist: "Fotty Seven ft. Krsna",
    image: "./songs/images/baap-se.jpg",
    wallpaper: "./songs/images/baap-se-background.jpg", 
  },
  2:{
  ...
  8:{
    ...
    wallpaper: "./songs/images/villain-background.jpg", 
  },
  6:{
  ...
  7:{
    ...
    wallpaper: "./songs/images/SHEIKH-CHILLI-background.jpg", 
  },
  10:{
    name: "./songs/Songs/Rap/We Rollin.m4a",
    artist: "Sukhe, Deep Jandu, Shrey Sean, J Hind",
    image: "./songs/images/We-Rollin.webp",
    wallpaper: "./songs/images/We-Rollin-background.jpg", 
  },
};
